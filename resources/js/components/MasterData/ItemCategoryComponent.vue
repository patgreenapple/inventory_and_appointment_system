...
export default {
    ...
    methods : {
        ...
        getRecords() {
            axios.get('item_category/getrecords').then(response => {
        ...
        store() {
            axios.post('item_category/store', this.dataValues).then(response => {
        ...
        edit(id) {
            axios.get('item_category/edit/' + id).then(response => {
        ...
        destroy(id) {
            this.$confirm("Are you sure?", 'Delete', 'question').then(() => {
                    axios.get('item_category/destroy/' + id).then(response => {
                        this.messageBox('Success', response.data.message, 'success');
                     })
                });
        }
